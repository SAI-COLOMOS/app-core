...
export default EditArea = ({navigation, route}) => {
    ...
    return (
        <Flex fill>
            ...
            <ModalMessage title="Eliminar área" description="¿Seguro que deseas eliminar esta área? La acción no se podrá deshacer" handler={[modalConfirm, () => setModalConfirm(!modalConfirm)]} actions={[["Cancelar", () => setModalConfirm(!modalConfirm)], ['Aceptar', () => {setModalConfirm(!modalConfirm), deleteArea()}]]} dismissable={true} icon="help-circle-outline"/>
