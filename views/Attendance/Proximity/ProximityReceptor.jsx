...
import Animated, { log, useAnimatedStyle, useSharedValue, withRepeat, withSequence, withSpring, withTiming } from "react-native-reanimated"
    ...
    return (
      ...
      >
        <Flex
          ...
          center
        >
          <Animated.View style={[{ width: 110, height: 110, borderRadius: 10, position: "absolute", backgroundColor: theme.colors.secondary }, avatarAnimatedStyle]} />
          <ProfileImage
        ...
        >
          ...
          <Flex fill>
            ...
            >
              Al mantén esta pantalla activa, estarás actualizando la ubicación permitida para la toma de asistencia
            </Text>
          </Flex>
        </VStack>
      </VStack>
